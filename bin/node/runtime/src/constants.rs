...
pub mod congress {
    ...
    pub const ALLOW_MODIFY_DURATION: u64 = 1000 * 60 * 6; // 1 * DAY;

    pub const REVIEW_DURATION: u64 = 1000 * 60 * 6; // 7 * DAY;
}
...
pub mod referendum {
    ...
    pub const VOTE_DURATION: u64 = 1000 * 60 * 6; // 7 * DAY;

    pub const RECEIVE_REWARDS_DURATION: u64 = 1000 * 60 * 6; // 30 * DAY;
